...
function changeInputs() {
  if (window.ReactNativeWebView) {
    window.ReactNativeWebView.postMessage(JSON.stringify({ carregado: false }));
  }

  setTimeout(() => {
    doc.querySelector("div.hTKgDl").style.display = "none";

    doc.querySelector("input[name='email']").placeholder = "Digite seu email";
    doc.querySelector("input[name='key:1500004400582']").placeholder =
      "Digite seu nome";
    doc.querySelector("input[name='subject']").placeholder = "Digite o assunto";
    doc.querySelector("input[name='key:1500004400602']").placeholder =
      "Código de área + número";
    doc.querySelector("textarea[name='description']").placeholder =
      "Insira os detalhes da sua solicitação. Um membro da nossa equipe de suporte responderá assim que possível.";
    doc.querySelector("textarea[name='description']").rows = 4;
  }, 2000);
